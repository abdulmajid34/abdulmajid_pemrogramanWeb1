<?php
/**
 * matkul.php – Halaman manajemen data Mata Kuliah
...
<head>
    ...
    <meta name="description" content="Kelola data mata kuliah secara online dengan fitur tambah, edit, hapus berbasis AJAX.">
    ...
    <div class="page-header mb-4">
        <div class="d-flex align-items-center justify-content-between flex-wrap gap-3">
            <div>
                ...
                <p class="page-subtitle mb-0">Kelola daftar mata kuliah – tambah, edit, dan hapus.</p>
            </div>
            <button class="btn btn-add" onclick="siapkanTambah()" data-bs-toggle="modal"
                    data-bs-target="#modalMatkul" id="btnTambahMatkul">
    ...
    <div class="card table-card">
        <div class="card-body p-0">
            ...
            <div class="table-responsive">
                <table class="table table-hover align-middle mb-0" id="tabelMatkul">
                    <thead>
                        <tr>
...
<div class="modal fade" id="modalMatkul" tabindex="-1"
     aria-labelledby="modalMatkulLabel" aria-hidden="true">
        ...
        <div class="modal-content modal-custom">
            ...
            <form id="formMatkul" onsubmit="simpanData(event)">
                <div class="modal-body">
                    <input type="hidden" id="matkulId" name="id" value="">
                    <div class="mb-3">
                        <label for="inputMatkul" class="form-label">Nama Mata Kuliah <span class="text-danger">*</span></label>
                        <input type="text" class="form-control form-control-custom" id="inputMatkul"
                               name="matkul" placeholder="Contoh: Pemrograman Web" required>
                    </div>
                    <div class="mb-3">
                        <label for="inputSK" class="form-label">SKS <span class="text-danger">*</span></label>
                        <input type="number" class="form-control form-control-custom" id="inputSK"
                               name="sk" placeholder="Contoh: 3" min="1" max="6" required>
                    </div>
                </div>
